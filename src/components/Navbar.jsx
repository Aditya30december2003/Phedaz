          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <a
              ...
              className={`inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md transition-colors duration-300 ${
                isScrolled ? "text-white font-extrabold bg-teal-900 hover:bg-teal-800" : "text-gray-900 font-semibold bg-white hover:bg-gray-100"
              }`}
            >
              Get started
            </a>
            ...
            >
              <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                <div className="pt-4 pb-3 border-t border-gray-200">
                  ...
                  <a
                    href="#cap"
                    className="block px-3 py-2 mt-1 rounded-md text-base font-medium text-white bg-color hover:bg-teal-800"
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                    Get started
                  </a>
