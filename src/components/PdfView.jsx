      ...
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center text-red-600">
          ...
          <button 
            ...
            className="mt-4 px-4 py-2 bg-purple-100 text-blue-700 rounded-md hover:bg-purple-200"
          >
            Try Again
          </button>
        </div>
    ...
    <div className="flex items-center justify-center  py-20 ">
      <button
        onClick={() => window.open(pdfUrl, '_blank')}
         className="mt-0 text-center text-[1.7rem] w-[80%] md:w-[30%] p-2 mx-auto border-2 font-bold rounded-md shadow-[10px_10px_1px_1px_#0373fc] lg:hover:shadow-[10px_10px_1px_1px_#D6B4FC#0373fc] hover:scale-95 cursor-pointer"
